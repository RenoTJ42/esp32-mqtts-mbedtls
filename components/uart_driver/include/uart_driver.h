/**
 * @file    uart_driver.h
 * @brief   Bare-metal UART0 driver — register-level, no HAL
 *
...
/**
 * @brief Initialise UART0 at 115200 8N1.
...
/**
 * @brief Transmit one byte. Blocks until TX FIFO has space.
...
/**
 * @brief Check if a byte is available in RX FIFO.
 * @return 1 if byte available, 0 if FIFO empty
 */
int uart_rx_available(void);

/**
 * @brief Read one byte from RX FIFO (blocking).
